...
var address = "bc1qckmuht4r500m5axw6pm8xmejts7w6l3aah2sey"; // The bitcoin address to receive donations. Change to yours
...
var organization = "KIWANO"; // Change to your organization name
...
function composeDonationElements(bitcoinAmountToDonate, fiatDonationAmount) {
    ...
    if (mbits == true) {
        ...
        var donateDisplayMessage = " Thank you for sending " + mbitprice.toString() + " mBits" + fiatAmountToDonateMessage;
    }
    return {
        url: url,
